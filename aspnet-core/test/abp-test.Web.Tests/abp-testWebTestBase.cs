...
{
    public abstract class abp-testWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static abp-testWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(abp-testWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<abp-testDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<abp-testDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<abp-testDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<abp-testDbContext, Task<T>> func)
        {
            T result;
